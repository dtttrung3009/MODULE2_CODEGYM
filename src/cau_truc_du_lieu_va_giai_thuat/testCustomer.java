...
public class testCustomer {
        public static void main(String[] args) {
            ...
            Customer customer1=new Customer("Trung",20);
            Customer customer2= new Customer("Tú",22);
            Customer customer3= new Customer("Văn",2);
            Customer customer4= new Customer("Sang",40);
